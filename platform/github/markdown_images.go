...
func (c *Client) invalidMarkdownImageSource(err error) error {
...
func (c *Client) getRepositoryFileImage(
	ctx context.Context,
	owner, repo string,
	segments []string,
) (platform.MarkdownImage, error) {
...
func (c *Client) fetchRepositoryFile(
	ctx context.Context,
...
func (c *Client) repositoryFileError(err error) error {
...
func (c *Client) getAttachmentImage(
	ctx context.Context,
	owner string,
	parsed *url.URL,
) (platform.MarkdownImage, error) {
