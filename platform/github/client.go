...
type Client struct {
	...
	writeRateTracker        platform.RateObserver
	notificationRateTracker platform.RateObserver
	graphQLRateTracker      platform.RateObserver
	writeGraphQLRateTracker platform.RateObserver
	platformHost            string
...
func (c *Client) notificationGH() *gh.Client {
...
func (c *Client) writeHTTPClient() *http.Client {
...
// SetGraphQLRateTracker attaches the tracker used by Client's direct
// GraphQL HTTP helpers.
func (c *Client) SetGraphQLRateTracker(rateTracker platform.RateObserver) {
...
// sync reads).
func (c *Client) SetWriteRateTracker(rateTracker platform.RateObserver) {
...
func (c *Client) SetWriteGraphQLRateTracker(rateTracker platform.RateObserver) {
...
func (c *Client) ProbeWriteCredential(ctx context.Context) error {
	if c.source == nil {
		return platform.ErrMissingToken
	}
	_, err := c.source.Token(c.authContext(ctx, "", true))
	return err
}

func (c *Client) InstallationAuthenticationActive() bool {
...
func (c *Client) InvalidateListETagsForRepo(owner, repo string, endpoints ...string) {
	if c.invalidateETags == nil {
		return
	}
	c.invalidateETags(owner, repo, endpoints...)
}

func (c *Client) ListNotifications(ctx context.Context, opts platform.NotificationListOptions) ([]platform.NotificationThread, bool, error) {
...
func (c *Client) GetNotificationThread(ctx context.Context, threadID string) (platform.NotificationThread, error) {
	...
	c.trackNotificationRate(resp)
	if err != nil {
		return platform.NotificationThread{}, err
	}
	return c.normalizeNotification(notification), nil
}

func (c *Client) MarkNotificationThreadRead(ctx context.Context, threadID string) error {
	resp, err := c.notificationGH().Activity.MarkThreadRead(ctx, threadID)
	c.trackNotificationRate(resp)
	return err
}

func (c *Client) normalizeNotification(n *gh.Notification) platform.NotificationThread {
	if n == nil {
		return platform.NotificationThread{}
	}
	thread := platform.NotificationThread{
		ID:     n.GetID(),
		Reason: n.GetReason(),
		Unread: n.GetUnread(),
	}
...
func (c *Client) notificationItem(subjectType, apiURL, owner, repo string) (string, *int, string) {
	itemType := "other"
...
func (c *Client) ReplaceIssueLabels(
...
func (c *Client) ReplaceIssueAssignees(
...
func (c *Client) RequestPullRequestReviewers(
	ctx context.Context, owner, repo string, number int, usernames []string,
...
// given users.
func (c *Client) RemovePullRequestReviewers(
	ctx context.Context, owner, repo string, number int, usernames []string,
) error {
...
// tracker.
func (c *Client) trackRate(resp *gh.Response) {
...
func (c *Client) trackWriteRate(resp *gh.Response) {
...
func (c *Client) trackNotificationRate(resp *gh.Response) {
...
func (c *Client) trackGraphQLRateHeaders(resp *http.Response) {
	...
	c.graphQLRateTracker.UpdateFromRate(RateFromHeaders(
...
func (c *Client) trackWriteGraphQLRateHeaders(resp *http.Response) {
	...
	tracker.UpdateFromRate(RateFromHeaders(
		limit, remaining, time.Unix(resetUnix, 0).UTC(),
	))
}
...
func (c *Client) ListOpenPullRequests(ctx context.Context, owner, repo string) ([]*gh.PullRequest, error) {
	opts := &gh.PullRequestListOptions{
		State:   "open",
		PerPage: 100,
	}
	progress := c.progress(owner, repo, "pulls")
...
func (c *Client) ListOpenIssues(
	...
	progress := c.progress(owner, repo, "issues")
...
func (c *Client) ListRepositoriesByOwner(
...
func (c *Client) authenticatedLogin(ctx context.Context) (string, error) {
	...
	if c.viewerLogin != "" &&
		...
		c.now().Sub(c.viewerLoginAt) < c.viewerCacheTTL {
...
func (c *Client) AuthenticatedViewerLogin(ctx context.Context) (string, error) {
	return c.authenticatedLogin(ctx)
}

func (c *Client) AuthenticatedViewerCacheKey() string {
...
func (c *Client) GetIssueIfChanged(
	ctx context.Context,
	owner, repo string,
	number int,
	etag string,
...
func (c *Client) GetPullRequestIfChanged(
	ctx context.Context,
	owner, repo string,
	number int,
	etag string,
...
func (c *Client) GetUser(ctx context.Context, login string) (*gh.User, error) {
...
func (c *Client) ListIssueComments(
	...
	return c.listIssueComments(WithUnconditionalRead(ctx), owner, repo, number)
}

func (c *Client) ListIssueCommentsIfChanged(
	ctx context.Context, owner, repo string, number int,
) ([]*gh.IssueComment, error) {
...
func (c *Client) ListPullRequestReviewThreads(
	ctx context.Context,
	owner string,
	repo string,
	number int,
...
func (c *Client) ListPullRequestTimelineEvents(
	ctx context.Context, owner, repo string, number int,
...
func (c *Client) ListIssueTimelineEvents(
	ctx context.Context, owner, repo string, number int,
) ([]PullRequestTimelineEvent, error) {
	type graphQLResponse struct {
		Errors []graphQLError `json:"errors"`
...
func (c *Client) ListForcePushEvents(
	ctx context.Context, owner, repo string, number int,
...
func (c *Client) GetCombinedStatus(
...
func (c *Client) ListWorkflowRunsForHeadSHA(
...
func (c *Client) CreatePullRequestReviewCommentReply(
...
func (c *Client) CreateReviewWithComments(
	ctx context.Context,
	owner, repo string,
	number int,
	event string,
...
func (c *Client) ApplyReviewSuggestions(
	ctx context.Context,
	owner, repo string,
	number int,
...
func (c *Client) ensureReviewSuggestionPullMutable(
	ctx context.Context,
	owner string,
	repo string,
	number int,
...
func (c *Client) ensureReviewSuggestionHeadRepoReachable(
	ctx context.Context,
	owner string,
	repo string,
) error {
...
func (c *Client) githubSuggestionConflict(reason string, message string) error {
	return &platform.Error{
...
func (c *Client) githubSuggestionStaleState(message string) error {
	return &platform.Error{
...
func (c *Client) githubFileContentAtRef(
	ctx context.Context,
	owner string,
	repo string,
	path string,
...
func (c *Client) createCommitForReviewSuggestions(
	ctx context.Context,
	owner string,
	repo string,
	number int,
...
func (c *Client) ConvertPullRequestToDraft(
	ctx context.Context, owner, repo string, number int,
) (*gh.PullRequest, error) {
