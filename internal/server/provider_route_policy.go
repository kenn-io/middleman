...
var providerRouteDeclarations = []ProviderRouteRule{
	...
	{OperationID: "dispatch-workflow", Owner: ProviderHubOnly, PeerScope: federationauth.ScopeProviderWrite},
	{OperationID: "dispatch-workflow-on-host", Owner: ProviderHubOnly, PeerScope: federationauth.ScopeProviderWrite},
	...
	{OperationID: "list-workflow-run-jobs", Owner: ProviderHubOnly, PeerScope: federationauth.ScopeProviderRead},
	{OperationID: "list-workflow-run-jobs-on-host", Owner: ProviderHubOnly, PeerScope: federationauth.ScopeProviderRead},
	{OperationID: "list-workflow-runs", Owner: ProviderHubOnly, PeerScope: federationauth.ScopeProviderRead},
	{OperationID: "list-workflow-runs-on-host", Owner: ProviderHubOnly, PeerScope: federationauth.ScopeProviderRead},
	{OperationID: "list-workflows", Owner: ProviderHubOnly, PeerScope: federationauth.ScopeProviderRead},
	{OperationID: "list-workflows-on-host", Owner: ProviderHubOnly, PeerScope: federationauth.ScopeProviderRead},
